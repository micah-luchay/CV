...
let CIU = new slideShowSlide(1, "Presentation map to inform university officials of City owned utilities near CIU.", "Photos\\Examples\\Slideshow\\Columbia International University Infrastructure 24x36 V2.png", "Utilities near CIU");
let YCHA = new slideShowSlide(2, "Deliverable to Yacht Cove Homeowners Association regarding City vs. Privately owned utility assets.", "Photos\\Examples\\Slideshow\\Yacht Cove_Reduced.png", "Private vs. City owned assets at Yacht Cove");
